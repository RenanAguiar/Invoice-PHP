<form class="form-horizontal" action="/invoice/edit/{invoice_id}" method="POST">
    <input type="hidden" name='client_id' value='{client_id}'>
    <input type="hidden" name='invoice_id' value='{invoice_id}'>
    <div class="page-header">
        <h1>
            Invoice <small>edit</small>
        </h1>
    </div>
    ...
    <div class='col-md-4'>
        <label class="control-label col-sm-5" for="postal_code">Date of Issue:</label>
        ...
        <label class="control-label col-sm-5" for="postal_code">Due Date:</label>
        <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div id="contact_entries">
                <table class="table table-hover table-striped" id="invoice_items">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-md-1">
                                <button type="button" class="btn btn-danger btn-xs pull-d remove_line"><span class="glyphicon glyphicon-trash"></span></button>
                                <input type="hidden" class="form-control invoice_detail_id" name="invoice_detail_id[]" value="{invoice_detail_id}">
                            </td>
                        </tr>
                ...
                <input type="hidden" class="form-control" name="invoice_entries_del" id="invoice_entries_del" value="{invoice_entries_del}">
